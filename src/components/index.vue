    ...
    <loader :loading="loading">
      ...
      <template slot="body">
        ...
        <div class="page-container-wrap">
          ...
          <div class="introduce-search-container">
            <div class="introduce-search-box">
              ...
              <div class="word-content">
                <h3>
                  <span>公司部门级分类，寻找真实的面试经验、工作体验</span>
                </h3>
              </div>
              <div class="search-content">
                <div style="display: flex">
                  <input class="ais-SearchBox-input" type="text"
                         v-model.lazy="corporationSearch"
          ...
          <div class="announcement-container" style="width: 90%;padding: 0 20px;margin: 20px auto">
            <!-- 公告 -->
          ...
          <div class="page-container">
            <div class="left-corporation" style="width: 75%;margin-right: 10px;">
            ...
            <div class="right-article" style="width: 25%">
