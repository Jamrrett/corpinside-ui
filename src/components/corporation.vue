<template>
  ...
  <!--        </div>-->
          ...
          <div class="corporation-info-container">
            ...
            <div class="corporation-info">
              ...
              <span>&nbsp;{{ corporation.viewCount }} 热度</span>
              <span>·</span>
              <svg viewBox="0 0 1024 1024" width="14" height="14" style="vertical-align: -2px;">
                <path
              ...
              <span>&nbsp;{{ corporation.commentCount }} 条评论</span>
              <span>·</span>
              <svg viewBox="0 0 1024 1024" width="14" height="14" style="vertical-align: -2px;">
                <path
              ...
              <span>&nbsp;{{ corporation.likeCount }} 点赞</span>
            </div>
          </div>

  <!--        <div class="corporation-info-news"-->
  <!--             @click="weiYanDialogVisible = true"-->
  <!--             v-if="!$common.isEmpty($store.state.currentUser) && $store.state.currentUser.id === corporation.userId">-->
  ...
  <!--        </div>-->
        ...
        <!-- 内容 -->
        <div style="background: var(--background);display: flex">
          <div class="corporation-container my-animation-hideToShow">
            <div v-if="!$common.isEmpty(corporation.videoUrl)" style="margin-bottom: 20px">
              <videoPlayer :url="{src: $common.decrypt(corporation.videoUrl)}"
                           :cover="corporation.corporationCover">
              </videoPlayer>
            </div>

            <!-- 文章内容 -->
            <div>
              <div class="sort-article-first" style="margin-top: 14px">
                <div class="article-more" style="font-size: 20px" @click="showIntroduction">
              ...
              <div v-show="ifShowIntroduction">
                ...
                <div class="corporation-update-time">
                  <span>文章更新于 {{ corporation.updateTime }}</span>
                </div>
              </div>
            </div>
            <!-- 分类 -->
  <!--          <div class="corporation-sort">-->
  <!--            <span @click="$router.push({path: '/sort', query: {sortId: corporation.sortId, labelId: corporation.labelId}})">{{ corporation.sortCorporation.sortName +" ▶ "+ corporation.label.labelName}}</span>-->
  <!--          </div>-->

            <div>
              <div>
                <div class="sort-article-first">
                  <div class="article-more" style="font-size: 20px" @click="showDepartments">
                    <svg viewBox="0 0 1024 1024" width="15" height="22"
                       style="vertical-align: -2px;margin-bottom: -2px">
                    <path
...
<!--                </div>-->
          ...
          <!-- 评论 -->
          <div v-show="corporation.commentStatus === true">
            <comment :type="'corporation'" :source="corporation.id" :userId="corporation.userId"></comment>
          </div>
        </div>

        <!-- 公司文章 -->
        <div style="width: calc(30% - 40px);max-width:250px;margin:0 80px 20px 35px;display: flex;flex-direction: column">
          <div v-for="(sort, index) in sortInfo" :key="index">
            <div>
              <div class="sort-article-first">
                <router-link :to="{ path: `/sort/${sort.id}`, query: {corporationId: id} }" class="article-more">
                  <svg viewBox="0 0 1024 1024" width="17" height="17" style="vertical-align: -3px;">
                    <path
...
<style scoped>
  ...
  .corporation-info span:not(:last-child) {
    margin-right: 5px;
  }
