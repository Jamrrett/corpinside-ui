      ...
      <div v-if="!$common.isEmpty(recommendArticles)"
        ...
        <div v-for="(article, index) in recommendArticles"
          ...
          <div class="aside-post">
            ...
            <div class="aside-post-meta" style="margin: 5px 0">
              <span>
...
<!--            </div>-->
            ...
            <div class="aside-sort-label">
              <router-link :to="{ path: `/sort/${article.sortId}` }" style="text-decoration: none;color: inherit">
                <span style="margin-right: 12px">
                  <svg viewBox="0 0 1024 1024" width="13" height="15" style="vertical-align: -3px;">
                    <path
                    ...
                    <path
                      ...
                      fill="#FFA86A"></path>
                  </svg> {{ sortInfo[article.sortId-1].sortName }}
                </span>
              </router-link>
              <router-link :to="{ path: `/corporation/${article.corporationId}` }" style="text-decoration: none;color: inherit">
                <span style="margin-right: 12px">
                  <svg viewBox="0 0 1024 1024" width="18" height="19" style="vertical-align: -4px;">
                    <path
...
<style scoped>
  ...
  .aside-post-meta span:not(:last-child) {
    margin-right: 10px;
  }
