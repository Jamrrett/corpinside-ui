<template>
  <div>
    ...
    <el-form :model="article" :rules="rules" ref="ruleForm" label-width="110px"
             class="demo-ruleForm">
    ...
    methods: {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            if (this.$common.isEmpty(this.id)) {
              ...
              this.saveArticle(this.article, "/admin/article/updateArticle")
            }
          } else {
            this.$message({
              message: "请完善必填项！",
      ...
      deleteForm(formName) {
        this.$confirm('确认删除？', '提示', {
          ...
          this.$http.get(this.$constant.baseURL + "/admin/article/deleteArticle", {id: this.id, userId: this.article.userId}, true)
            .then((res) => {
