    ...
    <div class="introduce-search-container">
      <div class="introduce-search-box" style="color: var(--white)">
        <div class="user-head-container">
            <el-avatar class="user-avatar" @click.native="changeDialog('修改头像')" :size="100"
                       :src="currentUser.avatar"
            style="margin: 15px 10px 15px 30px"></el-avatar>
    ...
    <div class="page-container">
      <div class="user-article">
        <div class="article-first">
          ...
          <span style="font-size: 20px;padding-left: 5px">&thinsp;我的文章</span>
        </div>
        <div v-if="articleList.length === 0">
          <div style="display: flex;justify-content: center;margin-top: 100px">
            <div style="font-size: 20px">暂无文章，快去发表吧~</div>
          </div>
        </div>
        <div v-else
        ...
        <div class="user-info">
          ...
          <div class="myCenter" style="margin-top: 12px">
            ...
            <div class="user-content">
              <div>
                <el-input style="font-size: 14px;border: 1px solid #ccc;border-radius: 10px" maxlength="30" v-model="currentUser.username"></el-input>
              </div>
              <div>
                <div v-if="!$common.isEmpty(currentUser.email)" style="font-size: 14px">
