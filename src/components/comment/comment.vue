        ...
        <div style="flex: 1;padding-left: 12px">
          ...
          <div style="display: flex;justify-content: space-between">
            <div>
              ...
              <span class="commentInfo-master" v-if="item.userId === userId && item.commentType === 'article'">作者</span>
              ...
              <div style="flex: 1;padding-left: 12px">
                ...
                <div style="display: flex;justify-content: space-between">
                  <div>
                    ...
                    <span class="commentInfo-master" v-if="childItem.userId === userId && item.commentType === 'article'">作者</span>
